...
const staticPages = {
  ...
  case: { title: "用 AI Agent 開發與改善八種案例", lead: "我先選一個想解決的日常問題，讓 AI Agent 協助釐清需求、整理規格、製作原型與開發，再由我實際操作確認結果。從下面八個主題，選一個開始練習。", type: "case-overview" },
...
function navMarkup() {
  ...
  <aside class="mobile-drawer" aria-label="手機導覽" data-mobile-drawer>
    ...
    <nav class="drawer-links"><a href="index.html">首頁</a><a href="roadmap.html">完整學習地圖</a><a href="cases.html">實際案例</a><a href="prompts.html">完整提示詞</a><a href="skill-guide.html">Skill 啟動與搭配</a><a href="agent-team.html">子 Agent 分工實戰</a><a href="model-guide.html">AI 工具／模型選擇指南</a><a href="glossary.html">專有名詞</a><a href="mobile-app.html">手機 App 總覽</a><a href="maintainer-guide.html">維護者手冊</a></nav>
  </aside>`
}
...
const tutorialLessons = {
  ...
  "10": { summary: "驗收通過後才發布與使用；先選擇自己使用、加入主畫面或商店發布的路線，再完成備份、隱私檢查與發布後驗收。", input: "已驗收的個人工作台與版本紀錄", output: "可使用版本、備份與發布後更新流程", actions: ["自己使用可先以本機或 Web 方式開啟，再視需要加入手機主畫面", "公開前掃描個資、金鑰、公司資料與不應發布內容", "將已驗收版本備份到指定位置，保留回復能力", "開始真實使用後，依問題回到需求、文件、開發與驗收循環"], prompt: "請根據已通過驗收的個人工作台，產生發布與日常使用計畫。\n列出發布目標、備份、資料安全檢查、版本更新、失敗回復與發布後驗收。\n不得把本機可開啟宣稱為已正式上線；任何外部發布前先等待我確認。" }
}
...
const stageAcceptanceChecks = {
  ...
  "10": ["我已確認本輪版本通過驗收", "我已檢查個資、金鑰與不應公開的內容", "我已建立可回復的備份", "我已選定本機、加入主畫面或商店發布路線"]
}
...
function homePage() {
  return `${navMarkup()}<main class="page-shell"><section class="hero"><div><p class="eyebrow">AI SYSTEM DEVELOPMENT ACADEMY</p><h1>從模糊想法<br>走到自己的系統</h1><p class="lead">我不需要一開始就懂技術；我會先把想做的事說清楚，一步一步完成可驗收的 Web，之後再決定要不要延伸到 Android 或 iOS。</p><div class="button-row"><a class="button button-primary" href="stage-00.html">從我的第一關開始</a><a class="button button-secondary" href="roadmap.html">先看學習地圖</a></div></div><div class="hero-board"><h3>我會走完的一條路</h3><div class="board-flow"><span>先說清楚我想做什麼</span><span>再把規格整理完整</span><span>完成並驗收 Web</span><span>最後再選擇是否延伸 App</span></div></div></section>
...
function caseOverviewPage() {
  const topics = [{ label: "個人工作台", key: "case-workbench", art: "personal-workbench-v1.png", intro: "把今日工作、專案與每日回顧放在一起，先練習新增一項工作、完成它並查看結果。" }, ...Object.values(caseStudyThemes)]
  ...
  <div class="boundary-note"><strong>目前提供：</strong>八個主題的開發教學與提示詞；個人工作台另有可操作原型。其餘主題尚未交付完成的 App 或系統，需依步驟實作與驗收。</div>`
}
